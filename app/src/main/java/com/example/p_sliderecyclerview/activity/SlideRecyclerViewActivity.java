package com.example.p_sliderecyclerview.activity;
...
import com.example.p_sliderecyclerview.R;
import com.example.p_sliderecyclerview.adapter.InventoryAdapter;
import com.example.p_sliderecyclerview.bean.Inventory;
import com.example.p_sliderecyclerview.view.SlideRecyclerView;
...
public class SlideRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        itemDecoration.setDrawable(ContextCompat.getDrawable(this, R.drawable.ic_launcher_background));
